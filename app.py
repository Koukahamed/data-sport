...
# ── TRACKER TAB ──────────────────────────────────────
    ...
    with st.form("entry_form", clear_on_submit=True):
        ...
        with col2:
            t_session = st.selectbox("Séance", ["", "Jour 1 — Poussée", "Jour 2 — Tirage", "Jour 4 — Jambes", "Jour 5 — Full Body"])

        t_exercise = st.text_input("Exercice", placeholder="Ex: Machine convergente à plat")
